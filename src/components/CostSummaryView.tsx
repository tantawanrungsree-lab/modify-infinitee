      ...
      <div className="p-4 md:p-5 rounded-2xl bg-gradient-to-r from-slate-900 via-indigo-950/40 to-slate-900 border border-indigo-500/30 shadow-xl flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2.5 flex-wrap">
          <button
            ...
            className="flex items-center gap-1.5 px-3.5 py-2 bg-slate-800 hover:bg-slate-700 border border-slate-700 text-slate-200 text-xs md:text-sm font-medium rounded-xl transition cursor-pointer"
          >
          ...
          <table className="w-full text-left border-collapse min-w-[1550px]">
            ...
            <tbody className="divide-y divide-slate-800 text-xs text-slate-200">
              {sortedJobs.length === 0 ? (
                ...
                sortedJobs.map((job) => (
                  <tr key={job.id} className="hover:bg-slate-800/60 transition group">
